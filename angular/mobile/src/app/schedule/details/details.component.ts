...
import { Teacher, ScheduleCell } from 'ngx-core';
...
export abstract class DetailsComponent extends Page<any> {
  ...
  protected abstract get displayTargetAs():"teacher"|"class"|undefined;
